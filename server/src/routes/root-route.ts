...
const PRODUCTION_API_URL = env.PRODUCTION_API_URL;
const PRODUCTION_APP_URL = env.PRODUCTION_APP_URL;
...
<body>
	<div class="container">
		...
		<div class="links">
			...
			<a href="${isDevelopment() ? "http://localhost:5173" : PRODUCTION_APP_URL}" class="secondary">🌐 Aplicação Web</a>
		</div>
